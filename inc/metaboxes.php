 ...
 */
	...
	function dhhc_call_addCustomMetabox() {
		new dhhc_addCustomMetabox();
	}

	if ( is_admin() ) {
		add_action( 'load-post.php', 'dhhc_call_addCustomMetabox' );
		add_action( 'load-post-new.php', 'dhhc_call_addCustomMetabox' );
	}
	
	class dhhc_addCustomMetabox {

		/**
		 * Hook into the appropriate actions when the class is constructed.
		 */
		public function __construct() {
			add_action( 'add_meta_boxes', array( $this, 'dhhc_add_metabox' ) );
			add_action( 'save_post', array( $this, 'dhhc_save' ) );
		}

		/**
		 * Adds the meta box container.
		 */
		public function dhhc_add_metabox( $post_type ) {
			...
			if ( in_array( $post_type, $post_types )) {
				...
				add_meta_box(
					'class',
					__( 'class', 'dhhc' ),
					array( $this, 'dhhc_render_metabox_class' ),
					$post_type,
					'side',
					'low'
				);
				...
				add_meta_box(
					'style',
					__( 'style', 'dhhc' ),
					array( $this, 'dhhc_render_metabox_style' ),
					$post_type,
					'side',
					'low'
				);
		 ...
		 */
		public function dhhc_save( $post_id ) {
		 ...
		 */
		public function dhhc_render_metabox_class( $post ) {
		...
		public function dhhc_render_metabox_style( $post ) {
