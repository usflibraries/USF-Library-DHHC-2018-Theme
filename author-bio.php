	...
	<div class="author-info">
		<div class="mdl-grid">
			<div class="author-avatar mdl-cell mdl-cell--3-col mdl-cell--12-col-phone text-center">
				<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'dhhc_author_bio_avatar_size', 128 ) ); ?>
			</div><!-- /.author-avatar -->
			<div class="author-description mdl-cell mdl-cell--9-col mdl-cell--12-col-phone">
				<h2><?php printf( __( 'About %s', 'dhhc' ), get_the_author() ); ?></h2>
				<p><?php the_author_meta( 'description' ); ?></p>
				<p class="author-links">
					<?php
						if ( ! empty( get_the_author_meta( 'user_url' ) ) ) :
							printf( '<a href="%s" class="www mdl-button mdl-js-button">' . __( 'Website', 'dhhc' ) . '</a>', esc_url( get_the_author_meta( 'user_url' ) ) );
						endif;
					?>
					<?php
